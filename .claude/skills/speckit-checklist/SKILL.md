...
1. **Setup**: Run `.venv/Scripts/python.exe .specify/scripts/python/check_prerequisites.py --json` from repo root and parse JSON for FEATURE_DIR and AVAILABLE_DOCS list.
